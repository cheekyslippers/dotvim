...
syn match   verilogGlobal      "#if [a-zA-Z0-9_!=)(><]\+\>"
syn match   verilogGlobal      "#ifdef [a-zA-Z0-9_!=<>()]\+\>"
syn match   verilogGlobal      "#ifndef [a-zA-Z0-9_!=<>()]\+\>"
...
syn keyword uvmClass             uvm_component uvm_phase
syn keyword uvmMethod            accept_tr apply_config_settings begin_child_tr begin_tr build check clone
syn keyword uvmMethod            build_phase connect_phase run_phase main_phase check_phase end_of_elaboration_phase
syn keyword uvmMethod            start_of_simulation_phase extract_phase report_phase final_phase
...
syn keyword uvmClass             uvm_config_setting uvm_config_db uvm_resource_db
